...
{
    [Route(ConfigEndPoint.Prefix + ConfigEndPoint.Version + "packs")]
    [ApiController]
    public class PackController : ControllerBase
    {
        ...
        public async Task<ActionResult> Insert(PackEntity entity)
        {
            try
            {
        ...
        [HttpPut]
        [Authorize(Roles = "admin")]
        public async Task<ActionResult> Update(Guid id, PackEntity entity)
        {
            try
            {
