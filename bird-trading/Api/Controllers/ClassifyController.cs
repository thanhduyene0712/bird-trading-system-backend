...
{
    [Route(ConfigEndPoint.Prefix + ConfigEndPoint.Version + "classifies")]
    [ApiController]
    public class ClassifyController : ControllerBase
    {
        private readonly IClassifyService _service;

        public ClassifyController(IClassifyService service)
        {
            _service = service;
        }
        ...
        [HttpPost]
        [Authorize(Roles = "admin")]
        public async Task<ActionResult> Insert(ClassifyEntity entity)
        {
            try
            {
        ...
        [HttpPut]
        [Authorize(Roles = "admin")]
        public async Task<ActionResult> Update(Guid id, ClassifyEntity entity)
        {
            try
            {
